        ...
        <div className="w-full py-[10rem] px-4 bg-[#030637]">
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
                <div className="w-full shadow-lg text-white border flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 ">
                    <img className="w-20 mx-auto mt-[-3rem] bg-white rounded-3xl" src={Explorer} alt="/" />
                ...
                <div className="w-full shadow-lg text-white border flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 ">
                    <img className="w-24 mx-auto mt-[-3rem] bg-white rounded-2xl" src={Advance} alt="/" />
                    <h2 className="text-2xl font-bold text-center py-8">Pro Analyst </h2>
                    <p className="text-center text-4xl font-bold">$80</p>
                    <div className="text-center font-medium">
                        <li>All features from the Explorer's Bundle</li>
                        <li className="py-2 border-b mx-8 mt-8">Advanced predictive analytics tools</li>
                ...
                <div className="w-full shadow-lg text-white border flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 ">
                    <img className="w-24 mx-auto mt-[-3rem] bg-white rounded-2xl" src={Executive} alt="/" />
